        ...
        <jsp:include page="header.jsp"></jsp:include>
            ...
            <jsp:include page="menu.jsp"></jsp:include>
                ...
                <div id="rightContent">
                    ...
                    <form action="/Laptop/ManagerProductServlet" method="post">
                        <table width="95%">
                        ...
                        <tr><td><b>Mã thương hiệu</b></td><td><input type="text" class="sedang" name="mathuonghieu" value="<%=product.getBrandID()%>">
