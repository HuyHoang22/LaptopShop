        ...
        <jsp:include page="header.jsp"></jsp:include>
            ...
            <div class="check-out">	 
                <div class="container">	 
                    ...
                    <tr class="cross1">
                        <td class="t-data">
                            <a href="single.jsp?productID=<%=list.getValue().getProduct().getProductID()%>">
                        ...
                        <td class="t-data"><div class="quantity"> 
                                <div class="quantity-select">            
                                    <div onClick="window.location.reload();" class="entry value-minus" data-sub="CartServlet?command=minus&productID=<%=list.getValue().getProduct().getProductID()%>"><a >&nbsp;</a></div>
                                    <div class="entry value"><span class="span-1"><%=list.getValue().getQuantity()%></span></div>									

                                    <div onClick="window.location.reload();" class="entry value-plus active" data-add="CartServlet?command=plus&productID=<%=list.getValue().getProduct().getProductID()%>"><a >&nbsp;</a></div>
                                </div>
                        ...
                        <td class="t-data"><a href="CartServlet?command=remove&productID=<%=list.getValue().getProduct().getProductID()%>"><img src="images/circle.png" class="img-responsive2 " alt=""></a></td>
                ...
                <div class=" cart-total">
                    ...
                    <ul class="total_price">
                        ...
                        <li class="last_price"><span id="total"><%=formatter.format(cart.totalCart())%> VNĐ</span></li>
                        <div class="clearfix"> </div>
                    </ul>
