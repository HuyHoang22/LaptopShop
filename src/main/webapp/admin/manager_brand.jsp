    ...
    <body>
        ...
        <jsp:include page="header.jsp"></jsp:include>
            ...
            <jsp:include page="menu.jsp"></jsp:include>
                ...
                <div id="rightContent" style=" display: inline-block;">
                    ...
                    <button style="display: block"><a href="/Laptop/admin/insert_brand.jsp">Thêm thương hiệu</a></button>             
                    <table class="data" ">
                        <tr class="data">
                    ...
                    <center>
                        ...
                        <a href="/Laptop/ManagerBrandServlet?command=delete&brand_id=<%=brand.getBrandID()%>">Xóa</a>
                    </center>
                    </td>
                    </tr>
                    <% }%>
