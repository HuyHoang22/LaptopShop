            ...
            <div class="banner-right">
                <ul id="flexiselDemo2">
                    ...
                    <li><div class="banner-grid">
                            <h2>Top sản phẩm mới</h2><br/>

                            <div class="wome">
                                <a href="single.jsp?productID=<%=p.getProductID()%>" ><img class="img-responsive3" style="margin-left: auto; margin-right: auto;" src="<%=p.getProductImageForward()%>" alt="" />
                                </a>
                                <div class="women simpleCart_shelfItem">
                                    <a href="#"><img src="images/l5.png" alt=""></a>
                                    ...
                                    <a href="CartServlet?command=plus&productID=<%=p.getProductID()%>" data-text="Mua ngay" class="but-hover1 item_add">Mua ngay</a>
                                </div>						
                            </div>						
                        </div>
                    </li>
