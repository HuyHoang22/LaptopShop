                ...
                <div class="container">
                    <div class="header-left animated wow fadeInLeft" data-wow-delay=".5s">
                        <ul>
                            ...
                            <li><i class="glyphicon glyphicon-envelope" ></i><a href="mailto:contact@HAVshop.com">@HAVShop.com</a></li>
                            <li><i class="glyphicon glyphicon-earphone" ></i>+84788494909</li>
                            ...
                            <div class="cart box_1">
                                ...
                                <a href="checkout.jsp">
                                    <h3> <div class="total">
                                            ...
                                            <span class="last_price" ><%=formatter.format(cart.totalCart())%></span> VNĐ</div>
                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="navbar-header nav_2">
                            ...
                            <div class="navbar-brand logo-nav-left ">
                                <h1 class="animated wow pulse" data-wow-delay=".5s"><a href="index.jsp">HAV<span> SHOP</span></a></h1>
                            </div>
                        ...
                        <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                            <ul class="nav navbar-nav">
                                ...
                                <li style="padding: 10px 0px 0px 10px; ">
                                    <form method="POST" action="ManagerProductServlet">
                                        <input type="text" id="strsea" placeholder="Nhập tìm kiếm..." name="txtsearch" style="border: 0.5px solid gray; padding: 5px 0px 6px 5px; border-radius: 2.5px; opacity: 0.7"></input>
