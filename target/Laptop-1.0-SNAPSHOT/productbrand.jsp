...
<html>
    <head>
        ...
        <title>SẢN PHẨM THƯƠNG HIỆU - HAV SHOP</title>
        ...
        <jsp:include page="header.jsp"></jsp:include>
            ...
            <div class="banner-top">
                <div class="container">
                    ...
                    <h3 class="animated wow fadeInRight" data-wow-delay=".5s"><a href="index.jsp">Trang Chủ</a><label>/</label>Sản phẩm thương hiệu</h3>
            ...
            <div class="product">
                <div class="container">
                    ...
                    <div class="sellers animated wow fadeInUp" data-wow-delay=".5s">
                        ...
                        <div class="product-head">
                            <%
                                for (Product p : productGet.getListSellProduct()) {
                            %>
                ...
                <div class="col-md-9 animated wow fadeInRight" data-wow-delay=".6s">  
                        ...
                        <div class="col-sm-4 item-grid item-gr  simpleCart_shelfItem">
                            ...
                            <div class="grid-pro">
                                ...
                                <div class="women">
                                    ...
                                    <a> <h4>Đã bán :  <%=p.getProductNumber()%></h4></a>
