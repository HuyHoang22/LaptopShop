                                            ...
                                            <div class="login-mail" href="#">
                                                ...
                                                <fieldset disabled>
                                                    <div class="form-group">
                                                        <label for="disabledTextInput">Điều khoản tại website HAV SHOP</label>
                                                        <textarea type="text" id="disabledTextInput" class="form-control" placeholder="" style="height: 100px">* Mua hàng tại HAS không được đổi trả. &#10;* Bạn hãy chắc địa chỉ bạn gửi là đúng. &#10;* Sau 3 ngày không chuyển khoản, đơn hàng sẽ xóa.&#10;* Phải biết rằng admin cute phô mai que :3</textarea>
                                                </fieldset>

                                            </div>

                                    </div>
                                    <div class="col-md-6 login-do animated wow fadeInRight" data-wow-delay=".5s" style="width: 100%;">
                                        <label class="hvr-sweep-to-top login-sub" style="padding: 0.1em 1em; text-align: center;vertical-align: baseline;height: 40px;">
                                            <input type="hidden" value="insert" name="command" >
                                            <input type="submit" value="Đăng Ký">
                                        </label>

                                        <p>Bạn đã có tài khoản ?</p>
                                        <a href="login.jsp" class="hvr-sweep-to-top" style="padding: 0.1em 1em; text-align: center;vertical-align: baseline;height: 40px;">Đăng Nhập</a>
                                    </div>
                                    <div class="clearfix"> </div>
                                    </form>
                                </div>
