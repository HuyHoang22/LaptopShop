        ...
        <jsp:include page="header.jsp"></jsp:include>
            ...
            <jsp:include page="menu.jsp"></jsp:include>
                ...
                <div id="rightContent">
                    ...
                    <button style="display: block"><a href="/Laptop/admin/insert_product.jsp">Thêm sản phẩm</a></button>
                    ...
                    <tr class="data">
                        ...
                        <td class="data"><img class="hinhql" src="/Laptop/<%=product.getProductImage()%>"/></td>
                        <td class="data"><img class="hinhql" src="/Laptop/<%=product.getProductImageBack()%>"/></td>
                        <td class="data"><img class="hinhql" src="/Laptop/<%=product.getProductImageForward()%>"/></td>
                    ...
                    <center>
                        <a href="/Laptop/admin/update_product.jsp?command=update&product_id=<%=product.getProductID()%>">Sửa</a>&nbsp;| &nbsp;
                        <a href="/Laptop/ManagerProductServlet?command=delete&product_id=<%=product.getProductID()%>">Xóa</a>
                    </center>
                    </td>
                    </tr>
                    <% }%>
