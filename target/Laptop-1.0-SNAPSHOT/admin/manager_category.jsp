        ...
        <jsp:include page="header.jsp"></jsp:include>
            ...
            <jsp:include page="menu.jsp"></jsp:include>
                ...
                <div id="rightContent">
                    ...
                    <button style="display: block"><a href="/Laptop/admin/insert_category.jsp" >Thêm danh mục</a></button>
                    <table class="data">
                        <tr class="data">
                    ...
                    <center>
                        ...
                        <a href="/Laptop/ManagerCategoryServlet?command=delete&category_id=<%=category.getCategoryID()%>">Xóa</a>
                    </center>
                    </td>
                    </tr>
                    <% }%>
